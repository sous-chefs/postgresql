...
RSpec.describe PostgresqlCookbook::Helpers do
  ...
  describe '#data_dir(version)' do
    ...
    context 'with rhel family and Postgres 12' do
      let(:platform_family) { 'rhel' }

      it 'returns the correct path' do
        expect(subject.data_dir(pg_version)).to eq '/var/lib/pgsql/12/data'
      end
    end

    context 'with debian family and Postgres 12' do
      let(:platform_family) { 'debian' }

      it 'returns the correct path' do
        expect(subject.data_dir(pg_version)).to eq '/var/lib/postgresql/12/main'
      end
    end
  end
  ...
  describe '#conf_dir(version)' do
    ...
    context 'with rhel family and Postgres 12' do
      ...
      it 'returns the correct path' do
        expect(subject.conf_dir(pg_version)).to eq '/var/lib/pgsql/12/data'
      end
    end
    ...
    context 'with debian family and Postgres 12' do
      ...
      it 'returns the correct path' do
        expect(subject.conf_dir(pg_version)).to eq '/etc/postgresql/12/main'
      end
    end
  end
  ...
  describe '#platform_service_name(version)' do
    ...
    context 'with rhel family and Postgres 12' do
      ...
      it 'returns the correct service name' do
        expect(subject.platform_service_name(pg_version)).to eq 'postgresql-12'
      end
    end
